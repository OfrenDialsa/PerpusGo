...
// Index implements domain.JournalServices.
...
// Create implements domain.JournalServices.
func (j *journalService) Create(ctx context.Context, req dto.CreateJournalRequest) error {
	...
	if stock.Status != domain.BookStockStatusAvailable {
		return errors.New("book stock has been borrowed before")
	}
...
// Return implements domain.JournalServices.
